...
const sessionsData: Record<string, SessionSlot[]> = {
  'Lun 7-8:00': [{ id: '1', time: '8:00', patient: 'Federico M.', professional: 'Andrea', room: 'C2', status: 'ATTENDED', type: 'Seguimiento', day: 'Lun 7' }],
  'Lun 7-9:00': [{ id: '2', time: '9:00', patient: 'Ismael R.', professional: 'Andrea', room: 'C2', status: 'ATTENDED', type: 'Consulta', day: 'Lun 7' }],
  'Mar 8-10:00': [{ id: '3', time: '10:00', patient: 'Morena L.', professional: 'Yamila', room: 'C1', status: 'ATTENDED', type: 'Seguimiento', day: 'Mar 8' }],
  'Mar 8-16:00': [{ id: '4', time: '16:00', patient: 'Sofía P.', professional: 'Andrea', room: 'C3', status: 'CONFIRMED', type: 'Consulta', day: 'Mar 8' }],
  'Mié 9-14:00': [{ id: '5', time: '14:00', patient: 'Federico M.', professional: 'Andrea', room: 'C2', status: 'SCHEDULED', type: 'Seguimiento', day: 'Mié 9' }],
  'Mié 9-16:00': [{ id: '6', time: '16:00', patient: 'Nicolás C.', professional: 'Yamila', room: 'C1', status: 'SCHEDULED', type: 'Primera vez', day: 'Mié 9' }],
  'Jue 10-9:00': [{ id: '7', time: '9:00', patient: 'Vicky S.', professional: 'Yamila', room: 'C1', status: 'SCHEDULED', type: 'Seguimiento', day: 'Jue 10' }],
  'Jue 10-17:00': [{ id: '8', time: '17:00', patient: 'Camila R.', professional: 'Andrea', room: 'C2', status: 'CANCELLED', type: 'Consulta', day: 'Jue 10' }],
  'Vie 11-10:00': [{ id: '9', time: '10:00', patient: 'Morena L.', professional: 'Yamila', room: 'C1', status: 'SCHEDULED', type: 'Seguimiento', day: 'Vie 11' }],
  'Vie 11-15:00': [{ id: '10', time: '15:00', patient: 'Sofía P.', professional: 'Andrea', room: 'C3', status: 'SCHEDULED', type: 'Evaluación', day: 'Vie 11' }],
}

// Flatten all sessions for mobile list view
const allSessions = Object.values(sessionsData).flat().sort((a, b) => {
  const dayOrder = daysOfWeek.indexOf(a.day) - daysOfWeek.indexOf(b.day)
  if (dayOrder !== 0) return dayOrder
  return a.time.localeCompare(b.time)
})

const statusConfig: Record<string, { color: string; darkColor: string; icon: any; label: string; badgeVariant: string }> = {
  SCHEDULED: { color: 'from-pastel-blue/70 to-pastel-blue/40 border-blue-200/40', darkColor: 'dark:from-blue-900/70 dark:to-blue-900/50 dark:border-blue-700/40', icon: CalendarIcon, label: 'Programada', badgeVariant: 'blue' },
  CONFIRMED: { color: 'from-pastel-purple/70 to-pastel-purple/40 border-purple-200/40', darkColor: 'dark:from-purple-900/70 dark:to-purple-900/50 dark:border-purple-700/40', icon: CheckCircle2, label: 'Confirmada', badgeVariant: 'purple' },
  ATTENDED: { color: 'from-pastel-green/70 to-pastel-green/40 border-green-200/40', darkColor: 'dark:from-green-900/70 dark:to-green-900/50 dark:border-green-700/40', icon: CheckCircle2, label: 'Asistió', badgeVariant: 'green' },
  CANCELLED: { color: 'from-slate-100/60 to-slate-50/30 border-slate-200/40', darkColor: 'dark:from-slate-800/60 dark:to-slate-800/40 dark:border-slate-700/40', icon: XCircle, label: 'Cancelada', badgeVariant: 'gray' },
  NO_SHOW: { color: 'from-pastel-rose/70 to-pastel-rose/40 border-rose-200/40', darkColor: 'dark:from-rose-900/70 dark:to-rose-900/50 dark:border-rose-700/40', icon: AlertCircle, label: 'No asistió', badgeVariant: 'red' },
}
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-slate-700 dark:text-slate-200 px-1 sm:px-3">
              <span className="hidden sm:inline">Abril 2026 - </span>Semana 2
            </span>
                      ...
                      >
                        <div className="flex items-center justify-between gap-2">
                          <div className="flex items-center gap-2 min-w-0">
                            <span className={cn('h-2 w-2 shrink-0 rounded-full', profColors[session.professional])} />
                        ...
                        <div className="mt-1.5 flex items-center gap-3 text-xs text-slate-500 dark:text-slate-400">
                          ...
                          <span className="text-slate-400 dark:text-slate-500">{session.type}</span>
                        </div>
                      </motion.button>
                    )
                  })}
          ...
          <div className="space-y-4">
            <div className={cn(
              ...
              <div className="flex items-center gap-2 mb-2">
                <NeuBadge
                  variant={statusConfig[selectedSession.status].badgeVariant as any}
                  size="md"
                >
